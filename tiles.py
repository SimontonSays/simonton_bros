...
class Tile(pygame.sprite.Sprite):
    ...
    def draw_pipe_top(self):
        #pipe body color
        self.image.fill((40, 200, 60))

        #top rim
        pygame.draw.rect(self.image, (20, 120, 30), (0, 0, TILESIZE, 10))
        ...
        # highlight
        pygame.draw.rect(self.image, (80, 220, 100), (8, 10, 6, TILESIZE-10))
